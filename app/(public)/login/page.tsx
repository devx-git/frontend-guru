            ...
            <CardContent className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="/recuperar-password" className="text-xs text-green-400 hover:text-green-300 transition">
              ...
              <div className="flex gap-2">
                <Button 
                  ...
                  variant="outline" 
                  size="sm" 
                  className="flex-1 text-xs border-white/20 bg-white/5 text-white hover:bg-white/10 hover:border-green-500 rounded-full"
