        ...
        <div className="fixed top-0 left-0 right-0 z-50 bg-white border-b shadow-sm px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent font-oswald">
                Gurú
              </span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="bg-green-50 px-3 py-1.5 rounded-full shadow-sm flex items-center gap-1">
              ...
              <span className="text-xs font-semibold text-green-600 font-oswald">
      ...
      <div className="flex">
        ...
        <aside
          className={`
            ...
            ${isMobile ? "w-64" : ""}
            h-screen overflow-y-auto flex flex-col custom-scroll
          `}
        >
          {/* Logo */}
          <div className={`p-4 border-b flex items-center justify-between ${collapsed ? "px-2" : "px-4"}`}>
            <Link href="/dashboard" className={`flex items-center gap-2 ${collapsed ? "justify-center w-full" : ""}`}>
              ...
              {!collapsed && (
                <div>
                  <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent font-oswald">
                    Gurú
                  </h1>
          ...
          {/* Saldo en Sidebar (solo desktop no colapsado) */}
          {!isMobile && !collapsed && (
            <div className="mx-4 mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-green-600 font-oswald">
                  {saldo.toLocaleString()} créditos
                </span>
              </div>
            </div>
          ...
          {!isMobile && (
            <header className="bg-white border-b shadow-sm sticky top-0 z-30">
              <div className="px-6 py-4 flex items-center justify-between">
                <h1 className="text-xl font-semibold text-gray-800 font-oswald">
                  {pageTitle}
                </h1>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3 bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-2 rounded-full shadow-sm border border-green-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-lg font-bold text-green-600 font-oswald">
                        {saldo.toLocaleString()} créditos
                      </span>
                    </div>
                  </div>
